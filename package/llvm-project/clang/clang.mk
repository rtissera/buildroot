...
CLANG_SITE =  https://github.com/llvm/llvm-project/releases/download/llvmorg-$(BATOCERA_LLVM_PROJECT_VERSION)
...
# batocera
HOST_CLANG_CONF_OPTS += -DCMAKE_CXX_FLAGS="-Wno-error=stringop-overflow -Wno-changes-meaning" -DLLVM_INCLUDE_TESTS=OFF
